function open_metadata($id) {
    ...
    var fulluri = "/csw?service=CSW&version=2.0.2&request=GetRecordById&ElementSetName=full&Id=" + $id + "&outputSchema=http://www.isotc211.org/2005/gmd&outputFormat=application/json";
